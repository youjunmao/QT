...
#include "../../SignalAndSlot/subwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SubWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SubWidget_t qt_meta_stringdata_SubWidget = {
    {
QT_MOC_LITERAL(0, 0, 9), // "SubWidget"
QT_MOC_LITERAL(1, 10, 9), // "mySignals"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "SubWidget\0mySignals\0"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->mySignals(); break;
        case 1: _t->mySignals((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubWidget::mySignals)) {
                *result = 0;
            }
        }
        {
...
void *SubWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SubWidget.stringdata))
...
// SIGNAL 0
void SubWidget::mySignals()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void SubWidget::mySignals(int _t1, QString _t2)
{
